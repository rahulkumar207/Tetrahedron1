...
export default function About() {
    ...
    return (
        <>
            <Layout headerStyle={6} footerStyle={6} breadcrumbTitle="About Us">
                ...
                <div className="w-full max-w-5xl py-16 px-4">
                    <div className="section-title text-center">
    ...
    <p>
      We believe in delivering the best solutions at the most competitive prices. 
      Our commitment to continuous improvement and innovation ensures that clients 
      experience the most effective solutions. We promote inclusive growth across 
      the entire value chain to create sustainable solutions. Our post-delivery 
      services empower customers and make us their first choice.
    </p>

    <p>
      <strong>We guarantee a 10% improvement</strong> in quality, productivity, and 
      profit margin within <strong>10-12 weeks</strong>.
    </p>

    <p>
      Our expert team includes professionals from premier management schools like 
      <strong> IIM Calcutta</strong> and top technical institutes such as 
      <strong> IIT Delhi</strong> and <strong> IIT Roorkee</strong>. We enable our 
      clients to become high-performance businesses and foster long-term relationships.
    </p>
  </div> */}
                </div>
