        ...
        <section className={styles.solutionSection}>
          ...
          <div className={styles.solutionContent}>
            ...
            <div className={styles.solutionImageContainer}>
              <img src="https://dummyimage.com/500x300/000/fff" alt="Autonomous Mobile Robot" />
            </div>
          </div>
        ...
        <section className={styles.gallerySection}>
          ...
          <div className={styles.galleryContainer}>
            <div className={styles.galleryImage}>
              <img src="https://dummyimage.com/150x150" alt="Gallery Image 1" />
            </div>
            <div className={styles.galleryImage}>
              <img src="https://dummyimage.com/150x150" alt="Gallery Image 2" />
            </div>
            <div className={styles.galleryImage}>
              <img src="https://dummyimage.com/150x150" alt="Gallery Image 3" />
            </div>
            <div className={styles.galleryImage}>
              <img src="https://dummyimage.com/150x150" alt="Gallery Image 4" />
            </div>
            <div className={styles.galleryImage}>
              <img src="https://dummyimage.com/150x150" alt="Gallery Image 5" />
            </div>
          </div>
        </section>
